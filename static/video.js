    ...
    var t, e, n = {
            ...
            5083: function(t, e, n) {
                ...
                e.ZP = function(t, e) {
                    ...
                    var g = (0, r.Z)({}, f, p);
                    "." === g.base && (g.base = (0, o.getScriptPath)("jwplayer.js")), g.base = (g.base || (0, o.loadFrom)()).replace(/\/?$/, "/"), n.p = g.base, g.width = (0, i.a)(g.width), g.height = (0, i.a)(g.height), g.aspectratio = (0, i.R)(g.aspectratio, g.width), g.volume = (0, a.qh)(g.volume) ? Math.min(Math.max(0, g.volume), 100) : f.volume, g.mute = !!g.mute, g.language = h, g.intl = v;
                    ...
                    if (k) Array.isArray(k.playlist) && (g.feedData = k, g.playlist = k.playlist);
                        ...
                        var C = (0, a.ei)(g, ["title", "description", "type", "mediaid", "image", "images", "file", "sources", "tracks", "preload", "duration"]);
                        g.playlist = [C]
                    }
            ...
            623: function(t, e, n) {
                ...
                var H = function() {
                        ...
                        return e.getAllItems = function() {
                            ...
                            return this.items.reduce((function(e, n) {
                                ...
                                return r && (e[n] = "captions" !== n ? (0, q.serialize)(r) : JSON.parse(r)), e
                            }), {})
                        }, e.track = function(t) {
                            var e = this;
                            this.items.forEach((function(n) {
                                t.on("change:" + n, (function(t, r) {
                                    try {
                                        "captions" === n && (r = JSON.stringify(r)), U[e.namespace + "." + n] = r
                                    } catch (t) {
                    ...
                    X = n(4609),
                    J = n(5882),
                    $ = (n(4671), n(9926), function(t) {
                        this._events = {}, this.modelShim = new V.Z, this.modelShim._qoeItem = new R.Z, this.mediaShim = {}, this.setup = new N(this.modelShim), this.currentContainer = this.originalContainer = t, this.apiQueue = new i.Z(this, ["load", "play", "pause", "seek", "stop", "playlistItem", "playlistNext", "playlistPrev", "next", "preload", "setAllowFullscreen", "setConfig", "setCurrentAudioTrack", "setCurrentCaptions", "setCurrentQuality", "setFullscreen", "setPip", "requestPip", "addButton", "removeButton", "castToggle", "setMute", "setVolume", "setPlaybackRate", "addCues", "setCues", "setPlaylistItem", "stopCasting", "resize", "setCaptions", "setControls"], (function() {
                            return !0
                        }))
                    });
                ...
                function et(t, e) {
                    ...
                    init: function(t, e) {
                        ...
                        var c = t,
                            s = (0, o.ZP)((0, r.Z)({}, t), a);
                        s.id = e.id, s.setupConfig = c, (0, r.Z)(i.attributes, s, G.bv), i.getProviders = function() {
                            return new B.Z(s)
                        }, i.setProvider = function() {};
                        var l = (0, Q.Z)();
                        i.get("backgroundLoading") || (l = (0, X.Z)(l.getPrimedElement(), l));
                        var f = this.primeUi = new J.ZP((0, J.GU)(this.originalContainer)).once("gesture", (function() {
                        ...
                        return i.on("change:errorEvent", Y), this.setup.start(e).then((function(t) {
                            ...
                            n.setup && function(t, e, n) {
                                Promise.resolve().then((function() {
                                    ...
                                    if (!o) {
                                        var u = (0, K.Z)(t, r);
                                        K.Z.cloneIcon && u.querySelector(".jw-icon").appendChild(K.Z.cloneIcon("error")), et(t, u)
                                    }
                    ...
                    var h = (0, r.Z)({
                        ...
                        v = function(t, e) {
                            return function(t, n) {
                                ...
                                if (clearTimeout(e.timeoutId), e.retryWithoutCredentials && e.xhr.withCredentials) return s(i), void c((0, r.Z)({}, e, {
                                    xhr: null,
                                    withCredentials: !1,
                                    retryWithoutCredentials: !1
                                }));
            ...
            2799: function(t, e, n) {
                ...
                function d(t, e) {
                    S(t),
                        function(t, e) {
                            if (!e) return;
                            for (var n = document.createDocumentFragment(), r = p(e).childNodes, i = 0; i < r.length; i++) n.appendChild(r[i].cloneNode(!0));
                            t.appendChild(n)
                        }(t, e)
                }
                ...
                function g(t) {
                    for (var e = t.attributes, n = e.length; n--;) {
                        ...
                        if (/^on/.test(r) && t.removeAttribute(r), /href/.test(r)) {
                            var i = e[n].value;
                            !/javascript:|javascript&colon;/.test(i) && v.test(i) || (t.removeAttribute(r), console.warn("Invalid or unsafe URL"))
                        }
                    }
                    return t
                }
                ...
                function M(t, e, n, r) {
                    if (void 0 === n && (n = {}), void 0 === r && (r = document), v.test(t)) {
                        var o = r.createElement("a");
                        o.href = t, o.target = e, o = g((0, i.Z)(o, n)), a.Browser.firefox ? o.dispatchEvent(new MouseEvent("click", {
                            bubbles: !0,
                            cancelable: !0,
                            view: window
                        })) : o.click()
            ...
            8518: function(t, e, n) {
                ...
                function C(t, e, n) {
                    return (0, r.Z)({}, function(t) {
                        ...
                        e && (u.advertising = u.advertising || {}, P(u.advertising, e, "admessage"), P(u.advertising, e, "cuetext"), P(u.advertising, e, "loadingAd"), P(u.advertising, e, "podmessage"), P(u.advertising, e, "skipmessage"), P(u.advertising, e, "skiptext"));
                        "string" == typeof u.related ? u.related = {
                            heading: u.related
                        } : u.related = u.related || {};
                        n && P(u.related, n, "autoplaymessage");
                        i && (u.sharing = u.sharing || {}, P(u.sharing, i, "heading"), P(u.sharing, i, "copied"));
                        o && P(u, t, "abouttext");
                ...
                var x = function t(e, n) {
                    ...
                    var r, i = s[n];
                    if (!i) {
                        var o = e + "translations/" + (r = d(n), (/^n[bn]$/.test(r) ? "no" : r) + ".json");
                ...
                function S(t, e) {
                    var n = (0, r.Z)({}, t, e);
                    return Z(n, "errors", t, e), Z(n, "related", t, e), Z(n, "sharing", t, e), Z(n, "advertising", t, e), Z(n, "shortcuts", t, e), Z(n, "captionsStyles", t, e), n
                }
            ...
            5882: function(t, e, n) {
                            ...
                            o = function(e) {
                                if (t.dragged) _(t, a.Wp, e);
                                    ...
                                    var r = M(e),
                                        ...
                                        u = i - t.startX,
                                        c = o - t.startY;
                                    u * u + c * c > 36 && (_(t, a.nv, e), t.dragged = !0, _(t, a.Wp, e))
                                }
                                var s;
                                n || "touchmove" !== e.type || (s = e).preventDefault && s.preventDefault()
                            },
                            u = function(e) {
                                clearTimeout(r), t.el && (O(t), T(t, h), t.dragged && (t.dragged = !1, _(t, a.Sv, e)))
                            };
                        x(t, v), I(t, v, (function(r) {
                            if ((0, l.IV)(e, "jw-tab-focus"), !F(r)) {
                                ...
                                if (!t.directSelect || a === e) {
                                    var s = M(r),
                                        f = s.pageX,
                                        d = s.pageY;
                                    if (t.dragged = !1, t.startX = f, t.startY = d, T(t, h), "pointerdown" === c && r.isPrimary) {
                                        if (!n) {
                                            var p = r.pointerId;
                                            t.pointerId = p, e.setPointerCapture(p)
                                        }
                                        E(t, h, "pointermove", o, i), E(t, h, "pointercancel", u), E(t, h, "pointerup", u)
                                    } else "mousedown" === c ? (E(t, h, "mousemove", o, i), E(t, h, "mouseup", u)) : "touchstart" === c && (E(t, h, "touchmove", o, i), E(t, h, "touchcancel", u), E(t, h, "touchend", u))
                                }
                            }
                        }), i)
                    }
                ...
                function j(t) {
                    if (!t.handlers.select) {
                        ...
                        x(t, g), I(t, g, (function(n) {
                            var r = n.target;
                            F(n) || t.directSelect && r !== e || (n.isPrimary && "BUTTON" === r.tagName && r.focus(), t.lastStart = (0, s.z)(), t.clicking = !0)
                        })), E(t, g, "click", (function(n) {
                            F(n) || t.directSelect && n.target !== e || ((0, s.z)() - t.lastStart > 500 && !0 === t.clicking || (function(t, e) {
                                t.enableDoubleClick && ((0, s.z)() - t.lastClick < 300 ? (_(t, a.P, e), t.lastClick = 0) : t.lastClick = (0, s.z)())
                            }(t, n), _(t, a.ot, n)), t.clicking = !1)
                        }))
                    }
                }

                function x(t, e) {
                    if (i || (i = new b(document).on("interaction")), !t.handlers.init && !t.handlers.select) {
                        var n = t.el;
                        E(t, e, "blur", (function() {
                ...
                var S = {
                    ...
                    out: function(t) {
                        ...
                        } else p && E(t, a.U3, "mouseout", (function(e) {
                            _(t, a.U3, e)
                        }))
                    },
                    move: function(t) {
                    ...
                    enter: function(t) {
                        E(t, a.K5, m, (function(e) {
                            "Enter" !== e.key && 13 !== e.keyCode || (e.stopPropagation(), A(t, a.K5, e))
                        }))
                    },
                    keydown: function(t) {
                        E(t, m, m, (function(e) {
            ...
            6601: function(t, e, n) {
                ...
                var r = "8.25.8+commercial_v8-25-8.504.hls.js@1.1.5.jwplayer@mono.jwplayer-ads-dai@mono.jwplayer-ads-freewheel@mono.jwplayer-ads-googima@mono.jwplayer-ads-header-bidding@v6.0.2.jwplayer-ads-vast@mono.jwplayer-analytics@v3.39.0.jwplayer-analytics-kraken@v0.0.4.jwplayer-plugin-gapro@mono"
            },
            4225: function(t, e, n) {
                "use strict";
                n.d(e, {
                ...
                var r = n(7462),
                    ...
                    C = function(t, e) {
                        ...
                        if ("free" === P.edition() && (b = (0, r.Z)({
                            ...
                            }, i.ke, (0, u.ei)(b, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"]))), b.key = C, b.edition = j, b.error = P.error(), b.generateSEOMetadata = b.generateSEOMetadata || !1, "unlimited" === j) {
                        ...
                        if (b.related = y(b), b.ab && (b.ab = function(t) {
                            ...
                            var S = b,
                                Z = S.playlist,
                                E = S.related;
                            g(Z) && (b.playlist = m(Z)), E && g(E.file) && (E.file = m(E.file))
                        }
            ...
            576: function(t, e, n) {
                ...
                var S = function(t) {
                    var e, n;
                    if (t ? "string" == typeof t ? (e = Z(t)) || (n = document.getElementById(t)) : "number" == typeof t ? e = a.Z[t] : t.nodeType && (e = Z((n = t).id || n.getAttribute("data-jwplayer-id"))) : e = a.Z[0], e) return e;
                    if (n) {
                        var r = new x(n);
                        return a.Z.push(r), r
                    }
                ...
                D._ = k.ZP, D.utils = (0, r.Z)(b.Z, {
                    ...
                    tea: M.p,
                    UI: O.ZP
                }), D.utils.css.style = D.utils.style, D.vid = I.Z;
                var N = D,
                    B = n(7543),
                    R = /^(?:on(?:ce)?|off|trigger)$/,
                    q = function(t, e, n) {
                    ...
                    U = function(t, e) {
                        var n = {
                            reason: !("play" === t || "seek" === t || "pause" === t) && (0, B.C)() ? "interaction" : "external"
                        };
                        switch (t) {
                            case "play":
                            case "pause":
                ...
                (0, r.Z)(X, N), E(X), "function" == typeof Q.define && Q.define.amd && Q.define([], (function() {
                    return X
                }));
                var J = X;
            ...
            2963: function(t, e, n) {
                ...
                s.supports = function(t, e) {
                    ...
                    name: "shaka",
                    supports: function(t) {
                        return !(t.drm && !(0, a.d3)(t.drm)) && (!(!window.HTMLVideoElement || !window.MediaSource) && (f(t.mediaTypes) && ("hls" === t.type || "dash" === t.type || "mpd" === t.type || (t.file || "").indexOf("mpd-time-csf") > -1)))
                    }
                }), r.B.unshift({
                    name: "hlsjs",
                    supports: function(t) {
...
var jwDefaults = {
    ...
    "displaytitle": false,
    "height": 260,
    "key": "eX8ikscHLZPbH9VQ4STjoVVaxBN919WcCCI29FXeu2vWl2ZpCmujdhsqfq5bIurV",
    "logo": {
